...
import DesignIllustration from "../../images/Man Graph.webp";
import CustomersLogoStripImage from "../../images/customers-logo-strip copy.png";
    ...
    <>
      ...
      <Container>
        <TwoColumn>
          <LeftColumn>
            <Heading>
            Small  Business <span tw="text-primary-300 hover:text-pink-500">Innovations</span>
            </Heading>
            <Paragraph>
